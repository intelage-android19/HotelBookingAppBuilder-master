...
public class RoomDetailsAdapter extends RecyclerView.Adapter<RoomDetailsAdapter.ViewHolder>{
    ...
    public RoomDetailsAdapter(RoomDetailsActivity roomDetailsActivity, List<RooDetailsModel> roomDetailsList) {

        this.context = roomDetailsActivity;
        this.roomDetailsList = roomDetailsList;
    }

    @NonNull
    @Override
    public RoomDetailsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RoomDetailsAdapter.ViewHolder viewHolder, int i) {
